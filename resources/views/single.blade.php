        ...
        <main class="main">
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <div class="blog-details-author">
                    ...
                    <div class="blog-details-author-thumb d-flex align-items-center" style="height: 100%;">
                        <img src="{{ asset($post->user->profile->avatar) }}" alt="Author" style="width: 80px; height: 80px; border-radius: 50%;">
                    </div>
